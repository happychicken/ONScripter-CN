...
//				}
		...
		if (KeyEvent.KEYCODE_BUTTON_A == keyCode) {
			DemoGLSurfaceView.nativeKey(KeyEvent.KEYCODE_ENTER, 1);
			DemoGLSurfaceView.nativeKey(KeyEvent.KEYCODE_ENTER, 0);
		} else if (KeyEvent.KEYCODE_BUTTON_B == keyCode) {
			DemoGLSurfaceView.nativeKey(KeyEvent.KEYCODE_ESCAPE, 1);
			DemoGLSurfaceView.nativeKey(KeyEvent.KEYCODE_ESCAPE, 0);	
		} else if ( KeyEvent.KEYCODE_DPAD_UP == keyCode) {
			DemoGLSurfaceView.nativeKey(KeyEvent.KEYCODE_DPAD_UP, 1);
			DemoGLSurfaceView.nativeKey(KeyEvent.KEYCODE_DPAD_UP, 0);
		} else if ( KeyEvent.KEYCODE_DPAD_RIGHT == keyCode) {
			DemoGLSurfaceView.nativeKey(KeyEvent.KEYCODE_DPAD_RIGHT, 1);
			DemoGLSurfaceView.nativeKey(KeyEvent.KEYCODE_DPAD_RIGHT, 0);
		} else if ( KeyEvent.KEYCODE_DPAD_DOWN == keyCode) {
			DemoGLSurfaceView.nativeKey(KeyEvent.KEYCODE_DPAD_DOWN, 1);
			DemoGLSurfaceView.nativeKey(KeyEvent.KEYCODE_DPAD_DOWN, 0);	
		} else if ( KeyEvent.KEYCODE_DPAD_LEFT == keyCode) {
			DemoGLSurfaceView.nativeKey(KeyEvent.KEYCODE_DPAD_LEFT, 1);
	...
	public boolean onPrepareOptionsMenu( Menu menu )
	{
		...
		*/ 
		menu.add(Menu.NONE, Menu.FIRST + 9997, Menu.NONE, mActivity.getString(R.string.Menu_ScreenRatio));
		
		menu.add(Menu.NONE, (MENU_ITEM_ID_QUIT), Menu.NONE, mActivity.getString(R.string.Menu_Quit));

		if(mAutoSave)
		menu.add(Menu.NONE, Menu.FIRST + 9993, Menu.NONE, mActivity.getString(R.string.Menu_EnableAutoSave));
		else
		menu.add(Menu.NONE, Menu.FIRST + 9994, Menu.NONE, mActivity.getString(R.string.Menu_DisableAutoSave));

		menu.add(Menu.NONE, (MENU_ITEM_ID_BTN), Menu.NONE, mActivity.getString(R.string.Menu_VirButton));

		menu.add(Menu.NONE, (MENU_ITEM_ID_LIGHT), Menu.NONE, mActivity.getString(R.string.Menu_LightSettings));
	...
	public boolean onOptionsItemSelected( MenuItem item )
	{
		...
		if(d >= (MENU_ITEM_ID_USER_MENU_KEY_FIRST) && d <= (MENU_ITEM_ID_USER_MENU_KEY_LAST)){
			...
			nativeKey(419, 1);
			nativeKey(419, 0);
			ShowToast(mActivity.getString(R.string.Menu_DisableAutoSave));
		} 
		else if(d == Menu.FIRST + 9994){
			mAutoSave = true;
			nativeKey(419, 1);
			nativeKey(419, 0);
			ShowToast(mActivity.getString(R.string.AutoSave_Tip));
		} 
			...
			for(int i = 0; i < ratioItems.length; i ++){
				...
				if(w > 0 && h > 0){
					...
					ratioItems[i] = mActivity.getString(R.string.Full);
				}
			}
			AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(mActivity);
			alertDialogBuilder.setTitle(mActivity.getString(R.string.Conf_ScreenRatio));
