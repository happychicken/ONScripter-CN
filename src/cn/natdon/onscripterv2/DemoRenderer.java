...
{	
	...
	public void onSurfaceDestroyed() {
		Log.i("libSDL","libSDL: DemoRenderer.onSurfaceDestroyed(): paused " + mPaused + " mFirstTimeStart " + mFirstTimeStart );
...
class DemoGLSurfaceView extends GLSurfaceView_SDL {
	...
	public void onResume() {
		...
		Log.i("libSDL","libSDL: DemoGLSurfaceView.onResume(): mRenderer.mGlSurfaceCreated " + mRenderer.mGlSurfaceCreated + " mRenderer.mPaused " + mRenderer.mPaused);
