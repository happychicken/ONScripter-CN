...
int ONScripter::savescreenshotCommand()
{
    ...
    SDL_SaveBMP( surface, "savescreenshot.bmp" );
    SDL_FreeSurface( surface );
	__android_log_print(ANDROID_LOG_INFO, "ONScripter", "savescreenshotCommand filename: %s", filename);
    return RET_CONTINUE;
}

// added by simple
// param: filenameShot
int ONScripter::savescreenshotCommand(char* filename)
{
...
{
	__android_log_print(ANDROID_LOG_INFO, "ONScripter", "savegameCommand");
